...
public class DogObjects {
    public static void main(String[] args) {
        ...
        Dog dog1=new Dog();           // bunu yapma nedenimiz static olmadigi icin diger classta object

      /*  dog1.breed="Husky";    // eger bir tane olursa bunu kullanirsan
        dog1.size="Small";
        dog1.color="White";
        dog1.name="Ghost";
        dog1.age=4;
...
*/
     ...
     /*   System.out.println(dog1);
        ...
        // bunlarin sonucu hascode oluyor cunku cat class da to String yamadigim zaman
